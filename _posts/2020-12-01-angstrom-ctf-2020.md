...
tags: ctf writeups crypto binary-exploitation reverse-engineering misc
...
### Description
> **You thought Angstrom would have a stereotypical LSB challenge... You were wrong! To spice it up, we're now using the Most Significant Digit. Can you still power through it?<br>
Here's the encoded image, and here's the original image, for the... well, you'll see.<br><br>
