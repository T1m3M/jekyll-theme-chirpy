...
---
{% assign img_root = "/assets/img/posts/2020-11-30-cybertalents-cairo-university-2019-ctf" %}
...
after the script finished, now we can see a **flag.txt** which contains the flag <br> ``` flag{Scrip7ing_is_s0_4w3som3} ```
...
that's it!! we got the flag! <br> ```flag{WeWvPhPnXvA$QbWhQzQuWuQuQuQj}```
<hr />
...
![flag]({{img_root}}/flag.png) <br> ```flag{N3twRk_Tr@c_hV_m@ny_Det@ls}```
